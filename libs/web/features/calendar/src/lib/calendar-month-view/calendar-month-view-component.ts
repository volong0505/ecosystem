...
import { DataAccessEventStore } from '@ecosystem/data-access-event';
import { LunarUtil } from '@ecosystem/web-utils';
import { CalendarEventTagComponent } from '../calendar-event-tag/calendar-event-tag-component';
import { CalendarEventPopoverComponent } from '../calendar-event-popover/calendar-event-popover-component';

@Component({
  selector: 'calendar-month-view-component',
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
...
export class CalendarMonthViewComponent {
  public readonly store = inject(DataAccessEventStore);
