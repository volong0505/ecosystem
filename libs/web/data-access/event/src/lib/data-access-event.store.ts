...
import { DataAccessEventService } from './data-access-event.service';
...
export const DataAccessEventStore = signalStore(
    { providedIn: 'root'},
    withState(initialState),
    withMethods((store, service = inject(DataAccessEventService)) => ({
